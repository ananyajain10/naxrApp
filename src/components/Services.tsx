...
const FetchServices = () => {
  ...
  return (
    <>
      {loading ? <p className="text-center text-2xl text-white">Loading Services..</p> : (
                ...
                <BackgroundGradient
                  ...
                  <div className="p-4 sm:p-6 flex flex-col items-center text-center flex-grow">
                    <p className="text-lg sm:text-xl text-black mt-4 mb-2 dark:text-neutral-200">
                      {service.attributes.name}</p>
                    <p className="text-sm text-neutral-600 dark:text-neutral-400 flex-grow" >{service.attributes.description}</p>
                  </div>
                </BackgroundGradient>
              </div>
            )))
